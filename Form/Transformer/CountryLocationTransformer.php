...
class CountryLocationTransformer implements DataTransformerInterface
{
    /**
    ...
    /**
     * @param CountryManager $manager
     */
    public function __construct(CountryManager $manager)
    {
     ...
     *
     * @return Country|null The value in the original representation
     *
     * @throws TransformationFailedException When the transformation fails.
     */
    public function reverseTransform($countryId)
    {
        ...
        $country = $this->manager->findByCode($countryId);
