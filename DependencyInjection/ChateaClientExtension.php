...
class ChateaClientExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('chatea_client.welcome_country_users_limit', $config['welcome_country_users_limit']);
        $container->setParameter('chatea_client.welcome_channels_limit', $config['welcome_channels_limit']);
